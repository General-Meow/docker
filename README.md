...
- To use 'docker commit' you would first need to log into your account on the command line with `docker login`. This will then store your configuration in `.docker/config.json`
